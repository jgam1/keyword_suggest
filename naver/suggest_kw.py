	...
	for keyword in keywords:
		...
		while while_cond:
			try:
				...
				#//*[@id="autoFrame"]/div[1]/div[1]/div[1]/ul[1]/li[1]/a[1]
				#//*[@id="autoFrame"]/div[1]/div[1]/div[1]/ul[1]/li[3]
				#//*[@id="autoFrame"]/div[1]/div[1]/div[1]/ul[1]/li[8]/a[1]
				#<a href="#" class="atcmp_keyword" onclick="return false;"><span class="atcmp_keyword_txt"><strong>암호화폐 </strong>공개(ICO)<span class="spat ic_expand"></span></span></a>
				added = driver.find_element(By.XPATH, '//*[@id="autoFrame"]/div[1]/div[1]/div[1]/ul[1]/li['+str(child_index)+']/a[1]')
...
for file in files:
	...
	real_keywords = []
	file_name = ''
	file_name = today+str(file)[:len(file)-4]+'naver_suggests_results.csv'
	with open(file) as f:
		reader = csv.reader(f)
		for i in reader:
			keywords.append(i[0])
